...
export function Buttons() {
  ...
  const states: { state: string; props?: ButtonProps }[] = [
    ...
    { state: 'withBottomShadow Normal', props: { withBottomShadow: true } },
    { state: 'withBottomShadow Hover', props: { hover: true, withBottomShadow: true } },
    ...
    { state: 'As Icon', props: { asIcon: true, children: <TestIcon key="testIcon" /> } },
    {
      ...
      props: { asIcon: true, withBottomShadow: true, children: <TestIcon key="testIcon" /> },
    },
