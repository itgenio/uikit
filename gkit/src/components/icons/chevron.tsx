...
export function ChevronUp20FilledIcon({ className, ...props }: Partial<SvgIconProps> = {}) {
  return (
    <SvgIcon className={classNames('chevron-up-20-icon', className)} viewBox="0 0 20 20" {...props}>
      <path
...
export function ChevronDown20FilledIcon({ className, ...props }: Partial<SvgIconProps> = {}) {
  return (
    <SvgIcon className={classNames('chevron-down-20-icon', className)} viewBox="0 0 20 20" {...props}>
      <path
